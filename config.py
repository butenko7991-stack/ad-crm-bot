...
# Увеличивайте UPDATE_VERSION и обновляйте UPDATE_NOTES перед каждым деплоем.
# При старте бот проверяет, была ли уже отправлена рассылка с этой версией;
# если нет — рассылает UPDATE_NOTES всем пользователям.
UPDATE_VERSION = "1.1.0"
UPDATE_NOTES = (
    "🚀 *Мы обновили бота!*\n\n"
    "✨ *Что нового:*\n"
    "• Добавлено приветственное сообщение с кнопкой «Начать»\n"
    "• После каждого обновления вы будете получать информацию о новых функциях\n\n"
